...
INSERT INTO "new_servicos" ("ativo", "categoria_id", "duracao_min", "foto_url", "id", "nome", "valor") SELECT "ativo", "categoria_id", "duracao_min", "foto_url", "id", "nome", "valor" FROM "servicos";
DROP TABLE "servicos";

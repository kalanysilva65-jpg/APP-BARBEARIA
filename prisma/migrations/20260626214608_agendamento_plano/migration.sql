...
INSERT INTO "new_agendamentos" ("cliente_email", "cliente_id", "cliente_nome", "cliente_telefone", "criado_em", "data", "hora_inicio", "id", "status", "usuario_id", "valor_total") SELECT "cliente_email", "cliente_id", "cliente_nome", "cliente_telefone", "criado_em", "data", "hora_inicio", "id", "status", "usuario_id", "valor_total" FROM "agendamentos";

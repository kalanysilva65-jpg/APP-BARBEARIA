...
INSERT INTO "new_agendamentos" ("barbearia_id", "cliente_email", "cliente_id", "cliente_nome", "cliente_plano_id", "cliente_telefone", "conta_cliente_id", "criado_em", "data", "forma_pagamento", "hora_inicio", "id", "status", "usuario_id", "valor_total") SELECT "barbearia_id", "cliente_email", "cliente_id", "cliente_nome", "cliente_plano_id", "cliente_telefone", "conta_cliente_id", "criado_em", "data", "forma_pagamento", "hora_inicio", "id", "status", "usuario_id", "valor_total" FROM "agendamentos";
